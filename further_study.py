...
def custom_pop(input_list):
    ...
    """
    removed_last_item = input_list[-1]
    input_list[:] = input_list[:-1] # Cannot reassign list but can slice into it
    #input_list[-1:] = []
    return removed_last_item
...
def custom_equality(some_list, another_list):
    ...
    """
    len1 = custom_len(some_list)
    len2 = custom_len(another_list)
    if len1 != len2:
        return False
    for i in range(len1):
